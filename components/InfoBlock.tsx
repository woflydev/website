...
export const InfoBlockContainer = Element("div", {});
...
export const InfoBlock: FC<InfoBlockProps> = ({ children, type, color, style = {}, ...props }) => {
  const div = useRef();
  ...
  return (
    <>
      <InfoBlockContainer forwardedRef={div} style={toCssStyle} {...props}>
