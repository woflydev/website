import { BlogPreview, Box, HeroText, Input, NewsletterSignup, Text } from "components";
...
export const Blog: FC<BlogProps> = ({ postData }) => {
  ...
  return (
    <>
      ...
      <Text my={3}>
        I'm writing mostly about web development, tech news, and the occasional life wisdom. Use the search below to filter
        by title.
      </Text>
      <Box mb={5}>
